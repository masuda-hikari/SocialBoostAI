...
STOP_WORDS_JA = {
    ...
    "その他", "に関する", "たち", "ます", "ん", "なら", "に対して", "特に",
    "せる", "及び", "これら", "とき", "では", "にて", "ほか", "ながら", "うち",
    "そして", "とともに", "ただし", "かつて", "それぞれ", "または", "お", "ほど",
    "ものの", "に対する", "ほとんど", "と共に", "といった", "です", "とも", "ところ",
    "ここ", "あなた", "私", "僕", "俺", "彼", "彼女",
}
...
STOP_WORDS_EN = {
    ...
    "also", "now", "here", "there", "then", "once", "if", "my", "your", "our",
}
